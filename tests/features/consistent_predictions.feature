Feature: Consistent predictions
  ...
  Scenario Outline: Predictions stay consistent with previous versions
    ...
    And the value in column 'p_sens_class' should be '<p_sens_class>'
    And the value in column 'p_nonsens_class' should be '<p_nonsens_class>'
    And the value in column 'cp_1' should contain only '<cp_1>'
    And the value in column 'cp_2' should contain only '<cp_2>'
    And the value in column 'cp_3' should contain only '<cp_3>'
    And the value in column 'cp_4' should contain only '<cp_4>'
